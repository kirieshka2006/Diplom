...
urlpatterns = [
    ...
    path('info/management/', views.info_management, name='info_management'),
    path('info/create/', views.create_info_block, name='create_info_block'),
    path('info/<int:info_id>/edit/', views.edit_info_block, name='edit_info_block'),
    path('info/<int:info_id>/delete/', views.delete_info_block, name='delete_info_block'),
    path('info/section/create/', views.create_info_section, name='create_info_section'),
    path('info/section/<int:section_id>/edit/', views.edit_info_section, name='edit_info_section'),
    path('info/section/<int:section_id>/delete/', views.delete_info_section, name='delete_info_section'),

    # Техподдержка
    path('support/', views.support_view, name='support'),
    path('support/faq-management/', views.faq_management, name='faq_management'),
    path('support/faq/create/', views.create_faq, name='create_faq'),
    path('support/faq/<int:faq_id>/edit/', views.edit_faq, name='edit_faq'),
    path('support/faq/<int:faq_id>/delete/', views.delete_faq, name='delete_faq'),
    path('support/faq-category/create/', views.create_faq_category, name='create_faq_category'),
    path('support/faq-category/<int:category_id>/edit/', views.edit_faq_category, name='edit_faq_category'),
    path('support/faq-category/<int:category_id>/delete/', views.delete_faq_category, name='delete_faq_category'),
    ...
    path('api/equipment/<int:equipment_id>/edit/', views.edit_equipment, name='edit_equipment'),
